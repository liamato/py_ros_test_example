...
NAME = 'example_node_next_service'

class TestExampleNodeNextSrv(unittest.TestCase):
    def test_next_service(self):
        rp.init_node(NAME, anonymous=True)
        service = rp.ServiceProxy("example_node/next", Trigger)
...
if __name__ == '__main__':
    rostest.rosrun(PKG, NAME, TestExampleNodeNextSrv)
